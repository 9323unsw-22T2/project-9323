  ...
  return (
    <div className="home">
      ...
      <View style={{ alignItems: 'flex-end', marginRight: 10, marginTop: 0, float: 'right' }}>
                <img
                  style={{ width: 1100, height: 925, marginTop: 0 }}
      ...
      <h1 style={{ color: 'darkgray', fontWeight: 'normal', marginLeft: 80, fontSize: 50, fontFamily: 'Roboto' }}> Welcome to Your Online </h1>
      <h2 style={{ color: 'darkgray', fontWeight: 'normal', marginLeft: 150, fontSize: 50, fontFamily: 'Roboto' }}>Information Hub</h2>
    </div>
